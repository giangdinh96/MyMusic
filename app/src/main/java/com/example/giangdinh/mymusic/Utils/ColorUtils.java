...
public class ColorUtils {
    ...
    public static int getColorRandom() {
        int positionColorRandom = new Random().nextInt(ColorUtils.COLOR.length);
        String colorRandom = "#".concat(COLOR[positionColorRandom]);
        return Color.parseColor(colorRandom);
    }
}
